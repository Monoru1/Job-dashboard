// FRONTEND React – Formulaire de recherche + Auth + Upload CV + Résultats
...
export default function App() {
  ...
  const api = axios.create({
    baseURL: 'https://YOUR_BACKEND_URL.onrender.com',
  });
          ...
          <div className="mt-4">
            ...
            {results.map((job, i) => (
              <div key={i} className="border p-2 mb-2">
                ...
                <a href={job.url} target="_blank" className="text-blue-600">Voir l'offre</a>
              </div>
            ))}
          </div>
        </>
